    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <script>
            ...
            $menu.addEventListener('mouseover', function () {
                ...
                $menu.style.background = 'url("https://search.pstatic.net/common/?src=http%3A%2F%2Fshop1.phinf.naver.net%2F20210826_289%2F1629968179395714ar_JPEG%2F4uz7e2y_202182520622762357.jpg&type=a340") no-repeat';
