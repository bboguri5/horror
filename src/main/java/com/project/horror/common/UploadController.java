package com.project.horror.common;

import com.project.horror.util.FileUtils;
...
//        }
    ...
    @ResponseBody // files로 넘어옴  139줄 ResponseEntity를하는이유 헤더정보를담을수잇음 못담아도해야함
    public ResponseEntity<List<String>> ajaxUpload(List<MultipartFile> files) {
        ...
        return new ResponseEntity<>(fileNames, HttpStatus.OK); // upload-form fetch에보냄 164줄
    }
